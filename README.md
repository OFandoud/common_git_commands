...
## Created by: Omar Fandoud

### Sections
- [Why git and github?](https://github.com/OFandoud/common_git_commands#why-git-and-github)
- [Git basic commands](https://github.com/OFandoud/common_git_commands#git-basic-commands)
- [Configuration](https://github.com/OFandoud/common_git_commands#configuration)
- [Removing files and directories](https://github.com/OFandoud/common_git_commands#removing-files-and-directories)
- [Moving and Renaming files](https://github.com/OFandoud/common_git_commands#moving-and-renaming-files)
- [Tags](https://github.com/OFandoud/common_git_commands#tags)
- [Branches](https://github.com/OFandoud/common_git_commands#branches)
- [Aliasing](https://github.com/OFandoud/common_git_commands#aliasing)
- [Stash](https://github.com/OFandoud/common_git_commands#stash)
- [Rebase](https://github.com/OFandoud/common_git_commands#rebase)
- [Squash](https://github.com/OFandoud/common_git_commands#squash)
- [Dealing with GitHub](https://github.com/OFandoud/common_git_commands#dealing-with-github)
 ---
